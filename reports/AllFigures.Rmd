...
plot(hc, xlab="Dissimilarity = 1 - Correlation", main="Average Linkage")
...
Figure 3: Compared to MCC tumors, UISO cells have more differentially expressed genes than classic MCC cell lines.
-----------------------
