...
```{r figs0, fig.width=15, fig.height=15}
...
```{r prepfigS1, message=FALSE, warning=FALSE, echo=FALSE, fig.width=15, fig.height=5}
...
p <- p + ylim(c(0.5,1))
p <- p + theme_bw() + theme(axis.text.x=element_text(size=20, angle=270, vjust=0.5), 
