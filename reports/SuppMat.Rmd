...
## Supplemental Table 4: Antibodies used in immunohistochemical analysis. Legend: $^{*}$ paranuclear dot pattern; $^{**}$ focal staining with negative regions.

```{r TableS4, results='asis', echo=FALSE}

antibody.data <- read.csv("../data/antibodies.csv")
colnames(antibody.data) <- c("Antibody", "Company", "Dilution", "Antigen retrievial", "WaGa", "UISO")
