...
write.table(predictions.combined, file="tables/tables4.csv")
...
write.table(avgoobvotes.formatted, file="tables/tables5.csv")
```
...
write.table(antibody.data, file="tables/tables6.csv")
```
...
write.table(str.data, file="tables/tables7.csv")
```
