...
pData(eset.tumors)$MCPyV.status <- factor(pData(eset.tumors)$MCPyV.status,
...
fit.tumors.MCPyV.status <- lmFit(eset.tumors, design.tumors.MCPyV.status,
                                 weights=array.weights, method="ls")

fit2.tumors.MCPyV.status <- contrasts.fit(fit.tumors.MCPyV.status,
                                          cont.matrix.tumors.MCPyV.status)
...
fit.tumors.privsmet <- lmFit(eset.tumors, design.tumors.privsmet,
                             weights=array.weights, method="ls")

fit2.tumors.privsmet <- contrasts.fit(fit.tumors.privsmet,
                                      cont.matrix.tumors.privsmet)
...
fit.tumors.recurrence <- lmFit(eset.tumors, design.tumors.recurrence,
                               weights=array.weights, method="ls")

fit2.tumors.recurrence <- contrasts.fit(fit.tumors.recurrence,
                                        cont.matrix.tumors.recurrence)
...
fit.tumors.stage.code <- lmFit(eset.tumors, design.tumors.stage.code,
                               weights=array.weights, method="ls")

fit2.tumors.stage.code <- contrasts.fit(fit.tumors.stage.code,
                                        cont.matrix.tumors.stage.code)
